...
We also write the tests on our side. It's more work, but it's a choice we made—for trust. This worked for survival. But as we open-source Actionbase, we're exploring a new model—one where anyone can contribute contracts. What that looks like is still evolving.

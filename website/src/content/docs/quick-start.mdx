...
At write time, Actionbase precomputes everything for reads—counts, indexes, ordering. No aggregation needed at query time.
...
List edges from a source, ordered by index:

...
- **OUT**: "What did Alice like?" (user's liked items)
- **IN**: "Who liked Phone?" (users who liked this product)
...
**What did Alice like?** (OUT direction)

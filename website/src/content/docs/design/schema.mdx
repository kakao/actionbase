...
Schema uses v2 API. Mutation and query use v3. Schema v3 is planned.

See [Glossary - API Version Mapping](/design/glossary/#api-version-mapping) for v2/v3 term differences.

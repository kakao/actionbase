...
해시 프리픽스는 HBase region 전체에 고르게 분산되도록 하여 핫스팟을 방지합니다.
...
[//]: # 'TODO: Add related documents when available' [//]: # '## Related Documents' [//]: # '- [How Both-Directed Edges Work](/ko/internals/explained/edge-both-directed/)' [//]: # '- [How Out-Directed Edges Work](/ko/internals/explained/edge-out-directed/)' [//]: # '- [How Multi-Edges Work](/ko/internals/explained/multi-edge/)' [//]: # '- [How Aggregation Works](/ko/internals/explained/aggregation/)'

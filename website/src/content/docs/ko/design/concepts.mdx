...
엣지 정의는 [스키마](/design/schema/)를 참고하세요.
...
자세한 내용은 [뮤테이션](/design/mutation/)을 참조하세요.
...
이러한 구조가 어떻게 만들어지는지는 [뮤테이션](/design/mutation/)을 참조하세요. 접근 방법은 [쿼리](/design/query/)를 참조하세요.
...
[쿼리](/design/query/)를 참고하세요.

## 다음 단계

- [스키마](/design/schema/): 엣지 구조를 정의합니다.
- [가이드](/guides/build-your-social-media-app/): 실습 튜토리얼

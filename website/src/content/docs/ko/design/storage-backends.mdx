...
HBase는 직접 사용할 경우 전문 지식이 필요합니다(행 키 설계, 리전 분할, 클러스터 관리 등). Actionbase는 State/Index/Count와 같은 인터랙션 특화 기능을 갖춘 더 높은 수준의 추상화를 제공합니다.
...
- [데이터 인코딩](/ko/internals/encoding/): 데이터 인코딩 방식

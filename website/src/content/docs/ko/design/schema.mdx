...
자세한 내용은 [핵심 개념](/design/concepts/)을 참조하세요.
...
인덱스는 쓰기 시점에 미리 계산됩니다. 자세한 내용은 [쿼리](/design/query/)를 참고하세요.
...
- [뮤테이션](/design/mutation/): 데이터 쓰기
- [쿼리](/design/query/): 데이터 조회
- [메타데이터 API](/api-references/metadata/): API 레퍼런스

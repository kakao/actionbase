...
> **참고**: 다중 엣지 케이스(예: 동일한 사용자가 동일한 수신자에게 여러 번 선물한 경우)에서는 각 엣지에 고유한 `id`가 필요합니다. [FAQ](/faq/#what-is-the-difference-between-unique-edge-and-multi-edge)를 참조하세요.
...
- [스키마](/design/schema/) — 엣지 스키마를 정의하세요
- [빠른 시작](/quick-start/) — Actionbase를 몇 분 만에 체험해보세요

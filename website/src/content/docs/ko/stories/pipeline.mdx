...
> 이 스토리에서는 카카오가 내부적으로 Actionbase를 어떻게 활용하는지 공유합니다. 이러한 컴포넌트들을 오픈 소스로 공개할 예정이니 [로드맵](/community/roadmap/)을 참고하세요.
...
전체 흐름은 [뮤테이션](/design/mutation/)에서 확인할 수 있습니다.
...
- 비동기 처리: [최근 보기](/stories/kakaotalk-gift-recent-views/)가 WAL을 소비하고 변경 사항을 다시 전송합니다

...
<Aside>CLI는 내부적으로 REST API를 호출합니다. 명령 실행 시 만들어지는 HTTP 요청도 함께 확인할 수 있습니다.</Aside>
...
<div class="icon-rows">
  <div class="icon-row">
"Bob이 좋아한 것은?" <User size={18} /> <ArrowRight size={18} /> <Package size={18} />{' '} (direction: OUT)
  </div>
  <div class="icon-row">
"Phone을 좋아한 사람은?" <Package size={18} /> <ArrowLeft size={18} /> <User size={18} /> (방향: IN)
  </div>
</div>

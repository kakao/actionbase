...
| Path     | database      | Required | Database name                                |
| Path     | alias         | Required | Alias name                                   |
| Body     | table         | Required | Target table name                            |
...
| `POST /graph/v2/services/{service}` | `POST /graph/v3/databases/{database}` |
...
| `POST /graph/v2/services/{service}/labels/{label}` | `POST /graph/v3/databases/{database}/tables/{table}` |
...
| `POST /graph/v2/services/{service}/aliases/{alias}` | `POST /graph/v3/databases/{database}/aliases/{alias}` |

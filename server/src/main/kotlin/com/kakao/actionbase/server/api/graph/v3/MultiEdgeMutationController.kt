...
class MultiEdgeMutationController(
    ...
    fun mutateMultiEdge(
        ...
        v3MutationService
            .mutateMultiEdge(database, table, request, lock, mode = MutationMode.SYNC, requestContext = requestContext)
    ...
    fun mutateMultiEdgeInternalSync(
        ...
        v3MutationService
            .internalMutateMultiEdge(database, table, request, lock, internal = MutationMode.SYNC, requestContext = requestContext)
            .map { ResponseEntity.ok(it) }
}

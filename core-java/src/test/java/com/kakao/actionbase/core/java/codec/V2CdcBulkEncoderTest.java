...
public class V2CdcBulkEncoderTest {
  ...
  private static final String V2_BASE_LABEL_JSON_STRING = "{\"active\":true,\"name\":\"test_service.test_table\",\"desc\":\"this is a test table\",\"type\":\"INDEXED\",\"schema\":{\"src\":{\"type\":\"LONG\"},\"tgt\":{\"type\":\"STRING\"},\"fields\":[{\"name\":\"created_at\",\"type\":\"LONG\",\"nullable\":false},{\"name\":\"permission\",\"type\":\"STRING\",\"nullable\":true},{\"name\":\"memo\",\"type\":\"STRING\",\"nullable\":true}]},\"dirType\":\"BOTH\",\"storage\":\"hbase_sandbox\",\"indices\":[{\"name\":\"created_at_desc\",\"fields\":[{\"name\":\"created_at\",\"order\":\"DESC\"}]}],\"event\":false,\"readOnly\":false,\"mode\":\"ASYNC\"}";
  private static final String V3_EVENT_INSERT_JSON_STRING = "{\"type\":\"INSERT\",\"version\":1,\"source\":123,\"target\":\"Coffee10\",\"properties\":{\"created_at\":1, \"permission\":\"public\", \"memo\":\"Latte\"}}";
  private static final String V3_EVENT_DELETE_JSON_STRING = "{\"type\":\"DELETE\",\"version\":1,\"source\":123,\"target\":\"Coffee10\",\"properties\":{\"created_at\":1, \"permission\":\"public\", \"memo\":\"Latte\"}}";
  private static final String V2_CDC = "{\"table\":\"test_service.test_table_20250415_000000\",\"edge\":{\"ts\":1744667998065,\"src\":10132487,\"tgt\":2838957562,\"props\":{\"orderDisplay\":\"1\"},\"traceId\":\"01JRV51ZV7MX92D9M3Y47CE7A7\"},\"op\":\"UPDATE\",\"status\":\"IDLE\",\"before\":{\"active\":false,\"ts\":1744667983563,\"src\":10132487,\"tgt\":2838957562,\"props\":{\"orderDisplay\":\"1\"}},\"after\":{\"active\":false,\"ts\":1744667998065,\"src\":10132487,\"tgt\":2838957562,\"props\":{\"orderDisplay\":\"1\"}},\"acc\":0,\"alias\":\"test_service.test_table\",\"message\":null,\"audit\":{\"actor\":\"AsyncRequestProcessor\"},\"requestId\":\"41c4adba5cf86e0c555e10719729f8ab\",\"ts\":1744668000110,\"tenant\":\"test_tenant\",\"phase\":\"prod\",\"version\":\"2\"}";
  ...
  private String modifyLabelJson(String tableJson, String typeValue, String dirTypeValue) {
    ...
    if (dirTypeValue != null) {
      modifiedJson = modifiedJson.replace("\"dirType\":\"BOTH\"",
          "\"dirType\":\"" + dirTypeValue + "\"");
    }
  ...
  private EdgeTableDescriptor createEdgeTableDescriptor(String tableJsonString)
    ...
    LabelDescriptor newLabel = ImmutableLabelDescriptor.builder()
        .from(table)
        .name(RENAMED_LABEL)
        .desc(RENAMED_LABEL)
        .build();
    ...
    encodedValues.forEach(
        kv -> {
          if (kv instanceof KeyValue<?>) {
            Object decoded = codec.decodeAny((KeyValue<byte[]>) kv,
                table.schema().getPropertiesSchema());
  ...
  private void verifyStoredEdgeIndex(
    ...
    EdgePayload payload = decodedIndex
        .toEdgePayload(table.schema().getPropertiesSchema().hashToFieldNameMap());
  ...
  void testFetchIndexedLabelAndEncodeEdges() throws JsonProcessingException {
    ...
    // 2 items for indexed edges within a single index, covering both OUTBOUND and
    // INBOUND
    // directions.
    // 2 items for counter edges, one each for OUTBOUND and INBOUND directions.
    assertEquals(5, encodedValues.size());

    List<byte[]> expectedCounterKeys = Arrays.asList(
  ...
  void testFetchIndexedLabelAndEncodeEdgesOutboundOnly() throws JsonProcessingException {
    ...
    // 1 item for the hash edge.
    // 1 item for indexed edges within a single index, covering only OUTBOUND
    // direction.
  ...
  void testFetchIndexedLabelAndEncodeEdgesInboundOnly() throws JsonProcessingException {
    ...
    // 1 item for the hash edge.
    // 1 item for indexed edges within a single index, covering only INBOUND
    // direction.
